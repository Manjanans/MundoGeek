...
urlpatterns = [
    ...
    path('pedidoManga/<int:ident>',pedidoManga, name="pedidoManga"),
    path('pedidoPc/<int:ident>',pedidoPc, name="pedidoPc"),
    path('pedidoPlay/<int:ident>',pedidoPlay, name="pedidoPlay"),
    path('pedidoSwitch/<int:ident>',pedidoSwitch, name="pedidoSwitch"),
]
